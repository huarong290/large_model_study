 ...
 * <p>功能说明：</p>
 * <ul>
 *   <li>管理多个会话的 ChatMemory 实例</li>
 *   <li>每个会话通过 sessionId 进行隔离</li>
 *   <li>使用滑动窗口（MessageWindowChatMemory）自动淘汰旧消息</li>
 *   <li>记录会话的最后访问时间，支持超时清理</li>
 * </ul>
 *
 * <p>MessageWindowChatMemory 使用说明：</p>
 * <ul>
 *   <li>需要 ChatMemoryRepository 来持久化消息</li>
 *   <li>使用 InMemoryChatMemoryRepository 作为内存存储</li>
 *   <li>maxMessages 控制保留的最大消息数</li>
 *   <li>SystemMessage 会被特殊保留（不会被淘汰）</li>
 * </ul>
 *
 * @author AI Study
 * @since 1.0.0
...
public class ChatMemoryManager {
     ...
     * 超过此时间未访问的会话会被自动清理
     */
    @Value("${practice.session-timeout-minutes:30}")
    ...
    public void scheduledCleanExpiredSessions() {
        if (sessionTimeoutMinutes > 0) {
            cleanExpiredSessions(sessionTimeoutMinutes);
        }
    }
